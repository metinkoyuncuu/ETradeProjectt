...
public static class AuthMessages
{
    ...
    public const string AccountMustBeActivated = "Verify your email for active your account";
    public const string AccountAlreadyActivated = "Your account already activated";
}
